...
matplotlib_default_colors = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd',
...
def plot_parallel_coords(samples, categories=None, dim_names=None,
	...
	if 'color' in default_style and 'edgecolor' not in default_style:
		default_style['edgecolor'] = default_style['color']
		del default_style['color']
	if 'facecolor' not in default_style:
		default_style['facecolor'] = 'none'
	...
	if include_legend and classes is not None:
